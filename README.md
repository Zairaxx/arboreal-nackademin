...
<p>Fantastiskt bra jobbat! Bra responsivitet med navigationen, bra användning av flexbox för att låta innehållet placeras över varandra. Inga onödiga px-värden, och fint designat! 

Här är några punkter på förbättringar som jag kunde hitta efter att ha använt din sida några minuter:</p>
 </li>
